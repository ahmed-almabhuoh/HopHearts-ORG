...
<body>
    <header class="bg-[#FFE4B5] border-b border-[#FF6F61] fixed top-0 inset-x-0 z-50 shadow-lg">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="relative flex items-center justify-between h-16">
                ...
                <nav class="hidden md:flex md:space-x-8">
                    <a href="#about" class="text-[#8B4000] hover:text-[#FF6F61] transition-colors duration-300">About
                        Us</a>
                    <a href="#services"
                        class="text-[#8B4000] hover:text-[#FF6F61] transition-colors duration-300">Services</a>
                    <a href="#projects"
                        class="text-[#8B4000] hover:text-[#FF6F61] transition-colors duration-300">Projects</a>
                    <a href="#blog"
                        class="text-[#8B4000] hover:text-[#FF6F61] transition-colors duration-300">Blog</a>
                    <a href="#contact"
                        class="text-[#8B4000] hover:text-[#FF6F61] transition-colors duration-300">Contact</a>
                </nav>
        ...
        <div class="absolute inset-x-0 top-full origin-top-right transform p-2 transition-all duration-300 ease-out md:hidden"
            id="mobile-menu">
            <div class="bg-[#FFE4B5] shadow-lg ring-1 ring-black ring-opacity-5 rounded-lg">
                ...
                <div class="px-2 pt-2 pb-3 space-y-1">
                    <a href="#about"
                        class="block text-[#8B4000] hover:text-[#FF6F61] transition-colors duration-300">About Us</a>
                    <a href="#services"
                    ...
                    <a href="#blog"
                        class="block text-[#8B4000] hover:text-[#FF6F61] transition-colors duration-300">Blog</a>
                    <a href="#contact"
            ...
            <div class="mt-12 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
                ...
                <div class="bg-white p-8 rounded-lg shadow-lg">
                    <div class="flex items-center justify-center mb-4">
                        <svg class="w-12 h-12 text-[#FF6F61]" xmlns="http://www.w3.org/2000/svg" fill="none"
            ...
            <div class="mt-12 grid grid-cols-1 md:grid-cols-2 gap-12">
                ...
                <div class="bg-white p-8 rounded-lg shadow-lg border border-gray-200">
                    ...
                    <ul class="mt-6 space-y-4">
                        ...
                        <li class="flex items-center text-[#6D6D6D]">
                            <img class="w-6 h-6 mr-3" src="https://cdn-icons-png.flaticon.com/512/561/561127.png"
                                alt="Phone Icon" />
                            <span>(123) 456-7890</span>
                        </li>
                        <li class="flex items-center text-[#6D6D6D]">
                            <img class="w-6 h-6 mr-3" src="https://cdn-icons-png.flaticon.com/512/732/732200.png"
                                alt="Email Icon" />
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        ...
                        <li class="flex items-center text-gray-300">
                            <img class="w-5 h-5 mr-3" src="https://cdn-icons-png.flaticon.com/512/561/561127.png"
                                alt="Phone Icon" />
                            <span>(123) 456-7890</span>
                        </li>
                        <li class="flex items-center text-gray-300">
                            <img class="w-5 h-5 mr-3" src="https://cdn-icons-png.flaticon.com/512/732/732200.png"
                                alt="Email Icon" />
                            <span>info@hophearts.com</span>
                        </li>
                    </ul>
                    <div class="mt-4 flex space-x-4">
                        <a href="https://facebook.com" class="text-gray-300 hover:text-white">
                            <img class="w-6 h-6" src="https://cdn-icons-png.flaticon.com/512/733/733547.png"
                                alt="Facebook" />
                        </a>
                        <a href="https://twitter.com" class="text-gray-300 hover:text-white">
                            <img class="w-6 h-6" src="https://cdn-icons-png.flaticon.com/512/733/733579.png"
                                alt="Twitter" />
                        </a>
                        <a href="https://linkedin.com" class="text-gray-300 hover:text-white">
                            <img class="w-6 h-6" src="https://cdn-icons-png.flaticon.com/512/733/733561.png"
                                alt="LinkedIn" />
                        </a>
                        <a href="https://instagram.com" class="text-gray-300 hover:text-white">
                            <img class="w-6 h-6" src="https://cdn-icons-png.flaticon.com/512/733/733558.png"
                                alt="Instagram" />
                        </a>
                    </div>
                </div>
